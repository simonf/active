...
(function() {
  var areViewsListsDifferent, conn, cradle, database, doUpdate, formatCSVRow, formatter, fs, getUserFromSession, json, n3, replaceAttributeValue, root, server, updateViews;

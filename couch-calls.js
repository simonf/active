...
(function() {
  var areViewsListsDifferent, conn, cradle, database, doUpdate, formatCSVRow, formatter, fs, getUserFromSession, json, n3, replaceAttributeValue, root, server, suggest, updateViews;
  ...
  root.getToday = function(req, callback) {
    ...
    options = {};
    database.view('activity/today', options, function(err, dat) {
      if (err) {
